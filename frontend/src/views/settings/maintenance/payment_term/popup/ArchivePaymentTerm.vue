            ...
            <v-form ref="form" @submit.prevent="save">
                <v-card-text>
                    <div class="main-holder">
                         You are about to {{ !form.is_archived ? 'archive' : 'restore'}} <span class="font-weight-bold black--text">"{{ form.name }}"</span> payment-term. Are you sure you want to do this?
                    </div>
                </v-card-text>
                <v-divider></v-divider>
                <v-card-actions>
    ...
    export default {
        ...
        methods:{
            ...
            save(){
                ...
                this.loading = true;
                axios.put('api/payment-term/'+this.form.id,this.form)
                .then(response=>{
