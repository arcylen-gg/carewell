            ...
            <v-card class="view-diagnosis">
                ...
                <v-card-text>
                    <div class="main-holder">
                        <!-- <b-form-group> -->
                            <v-checkbox disabled v-model="is_sub_diagnosis" name="is_sub_diagnosis" label="Is Sub Diagnosis/Illness of"></v-checkbox><br> 
                            <!-- <b-form-checkbox  disabled v-model="is_sub_diagnosis" name="is_sub_diagnosis">Is Sub Diagnosis/Illness of</b-form-checkbox><br> -->
                            <v-select v-if="is_sub_diagnosis"
                                ...
                                solo flat></v-select>
                        <!-- </b-form-group> -->
                        <v-text-field readonly v-model="item.name" color="accent" label="Name" outline></v-text-field>
                        <v-textarea readonly v-model="item.description" color="accent" label="Description" solo flat></v-textarea>
                        <v-layout>
                            <v-checkbox disabled v-model="covered_first_year" name="covered_first_year" label="Covered First Year"></v-checkbox>
                            <v-checkbox disabled v-model="covered_after_year" name="covered_after_year" label="Covered After a Year"></v-checkbox>
                            <v-checkbox disabled v-model="exclusion" name="exclusion" label="Exclusion"></v-checkbox>
                        </v-layout>
                        <!-- <b-form-group v-model="row" class="display-block" row>
                            <b-form-checkbox disabled v-model="covered_first_year" name="covered_first_year">Covered First Year</b-form-checkbox>
                            <b-form-checkbox disabled v-model="covered_after_year" name="covered_after_year">Covered After a Year</b-form-checkbox>
                            <b-form-checkbox disabled v-model="exclusion" name="exclusion">Exclusion</b-form-checkbox>
                        </b-form-group> -->
                    </div>
                </v-card-text>
                <v-divider></v-divider>
