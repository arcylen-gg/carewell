<template>
    ...
    <v-dialog v-model="dialog" persistent scrollable max-width="500px">
        <v-btn slot="activator" depressed color="accent"><i class="fas fa-plus mr-3"></i>Create Specialization</v-btn>
        <v-card class="coverages-description">
            <v-card-title class="title" style="background-color: #222C3C; color: #fff;">Create Specialization</v-card-title>
    ...
    export default {
       data: () => ({
        ...
        methods : {
            ...
            {
                axios.post('/api/specialization', this.form).then(response =>
                {
