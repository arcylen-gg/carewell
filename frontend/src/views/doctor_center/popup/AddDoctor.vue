<template>
<span>
    <span slot="activator" @click="loadDialog"><slot>Default Button</slot></span>
    
    <v-dialog v-model="dialog" persistent scrollable max-width="700px">
        <v-card class="add-doctor">
            <v-card-title class="title" style="background-color: #222C3C; color: #fff;">Add Doctor</v-card-title>
            <v-card-text>
