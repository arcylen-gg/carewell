    ...
    <span>
        ...
        <v-dialog v-model="dialog" persistent scrollable max-width="950px">
            ...
            <v-card class="create-member">
                <v-card-title class="title" style="background-color: #222C3C; color: #fff;">Edit Member</v-card-title>
                <v-card-text>
                    ...
                    <div class="top-holder">
                        ...
                        <div class="top-input__holder">
                            ...
                            <v-text-field color="accent" label="Contact Number"  v-model="form.contact_number" outline></v-text-field>
                            <v-text-field color="accent" label="Email Address" v-model="form.email" outline></v-text-field>
                            <div></div>
                        </div>
                        ...
                        <div class="present-address">
                            <v-checkbox @change="presentAddress" label="Same with Permanent Address?" v-model="check_same_address" ></v-checkbox>
