    ...
    <table class="main-table">
        <thead>
            <tr>
                ...
                <th class="main-td">Chief Complain</th>
                <th class="main-td">Dx</th>
                <th class="main-td">Lab</th>
                <th class="main-td">Amt</th>
                <th class="main-td">Phy</th>
                <th class="main-td">PF</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="main-td">{{ $availment->availment->chief_complaint }}</td>
                <td class="main-td">{{ $availment->availment->diagnosis->name }}</td>
                <td class="main-td">
                ...
                <td class="main-td">
                    @foreach($availment->availment->availment_doctor as $doctor)
                        {{ $doctor->doctor->name }} ({{ $doctor->doctor->tax }})
                    @endforeach
                </td>
                <td class="main-td"  style="text-align: right !important">
                    <?php
                        ...
                        echo $amount_doctor_pf ? $amount_doctor_pf : '';
                    ?>
                </td>
                <td class="main-td"  style="text-align: right !important">
                    <?php
                ...
                <td class="main-td"  style="text-align: right !important">
                    <?php
                        $total_amount_charged_to_carewell[$key] = ($availment->availment->procedures_carewell_charged_total);
            ...
            <tr>
                ...
                <td class="main-td"><strong>Grand Total</strong></td>
                <td class="main-td"  style="text-align: right !important"><strong>{{ number_format($amount_doctor_pf, 2) }}</strong></td>
            ...
            <tr>
                ...
                <td class="main-td td-value"  style="text-align: right !important">
                    <strong>
                        <?php
                            $grand_total = ( array_sum($total_amount_charged_to_carewell) - array_sum($total_amount_doctor_pf) - array_sum($total_d_a) );
            ...
            @foreach($data->other['doctors'] as $key => $doctor)
                <tr>
                    <td colspan=6 class="main-td align-right"><strong>PLEASE MAKE CHECK PAYABLE TO:</strong></td>
                    <td class="main-td td-value"  style="text-align: right !important">
                        <strong>
                            <?php
                                $total_doctor_fee[$key] = ($doctor['total']);
                                echo number_format($total_doctor_fee[$key],2);
                            ?>
                        </strong>
                    </td>
                    <td colspan=8 class="main-td td-value"><strong>{{ $doctor['name'] }} ({{ $doctor['tax'] }})</strong></td>
                </tr>
            @endforeach
            <tr>
