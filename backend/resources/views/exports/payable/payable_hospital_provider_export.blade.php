        ...
        <tbody>
            <tr>
                @foreach($data->payable_availment as $availment)
                    ...
                    <td class="availment-td"> {{ number_format($availment->availment->provider_payee_fee, 2, '.', '') }} </td>
                    <!-- <td class="availment-td"> {{ $availment->availment->doctor_fee }} </td> -->
