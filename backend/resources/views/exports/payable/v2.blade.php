    ...
    <table class="main-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="main-td"  style="text-align: right !important">
                    <?php
                        $total_amount_charged_to_carewell[$key] = ($availment->availment->procedures_carewell_charged_total + $availment->availment->doctors_carewell_charged_total);
            ...
            <tr>
                ...
                <td class="main-td td-value"  style="text-align: right !important">
                    <strong>
                        <?php
                            $grand_total = ( array_sum($total_amount_charged_to_carewell) - array_sum($total_d_a) - $amount_doctor_pf );
